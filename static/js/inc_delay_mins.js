...
function makeGraphs(error, demandJson, new_data) {
 ...
 //  "July", "August", "September", "October", "November", "December"
  ...
  "July", "Aug", "Sep", "Oct", "Nov", "Dec"
	...
	var delayByCause = causeDim.group().reduceSum(function(d){
		return d.Delay
	});
	var delayByLocation = locationDim.group().reduceSum(function(d){
		return d.Delay
	});
	var delayByYear = YearDim.group().reduceSum(function(d){
		return d.Delay
	});
	var delayByHour = timeDim.group().reduceSum(function(d){
		return d.Delay
	});
	var delayByDay = dayDim.group().reduceSum(function(d){
		return d.Delay
	});
	var delayByMonth = monthDim.group().reduceSum(function(d){
		return d.Delay
	});
	var delayByLine = lineDim.group().reduceSum(function(d){
		return d.Delay
	});
